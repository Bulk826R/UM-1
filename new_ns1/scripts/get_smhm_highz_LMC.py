...
h = 0.7
omega_m = 0.286
src = '/sdf/group/kipac/u/ollienad/LMC_zoomins' 
wr = '/sdf/group/kipac/g/cosmo/ki21/ycwang/join_halos/LMC'

####################################

D = np.loadtxt(wr+'/Data_join_LMC_z0.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
...
D = np.loadtxt(wr+'/Data_join_LMC_z0p2.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z0p5.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z1.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z2.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z4.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z6.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z8.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
...
D = np.loadtxt(wr+'/Data_join_LMC_z10.txt')
Mstar = D[:, 23]
Vpeak = D[:, 14]
ID_all = np.where(Mstar > 0.)[0]
data_zoom = D[ID_all]
